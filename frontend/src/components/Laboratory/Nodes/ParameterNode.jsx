...
const ParameterNode = memo(({ data }) => {
  ...
  return (
    <div className={`px-3 py-2 shadow-md rounded-md bg-slate-900/80 backdrop-blur border-2 transition-all min-w-[130px] ${paramStyle}`}>
      ...
      <div className="flex flex-col gap-1">
        ...
        {storeKey ? (
          ...
          <div className="text-sm font-mono text-slate-200 px-2 py-1">{liveValue}</div>
        )}
